...
<template>
  <Dialog v-model:open="dialogOpen">
    ...
    <DialogContent>
      <DialogTitle>
        {{ $t('workspace.dialog.export-svg.title') }}
      </DialogTitle>
      <DialogDescription>
        {{ $t('workspace.dialog.export-svg.description') }}
      </DialogDescription>
      <Alert variant="warning">
        <LucideAlertTriangle class="size-4" />
        <AlertTitle>
          {{ $t('workspace.dialog.export-svg.experimental.title') }}
        </AlertTitle>
        <AlertDescription>
          {{ $t('workspace.dialog.export-svg.experimental.description') }}
        </AlertDescription>
      </Alert>

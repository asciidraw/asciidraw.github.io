...
<!--        <template #default>{{ $t('workspace.context-menu.cut.label') }}</template>-->
<!--        <template #shortcut>{{ $t('workspace.context-menu.cut.shortcut') }}</template>-->
<!--      </CustomContextMenuItem>-->
<!--      <CustomContextMenuItem :disabled="!hasElements" @click="handleCopy">-->
<!--        <template #icon><LucideClipboardCopy /></template>-->
<!--        <template #default>{{ $t('workspace.context-menu.copy.label') }}</template>-->
<!--        <template #shortcut>{{ $t('workspace.context-menu.copy.shortcut') }}</template>-->
<!--      </CustomContextMenuItem>-->
<!--      <CustomContextMenuItem :disabled="canPaste" @click="handlePaste">-->
<!--        <template #icon><LucideClipboardPaste /></template>-->
<!--        <template #default>{{ $t('workspace.context-menu.paste.label') }}</template>-->
<!--        <template #shortcut>{{ $t('workspace.context-menu.paste.shortcut') }}</template>-->
<!--      </CustomContextMenuItem>-->
<!--      <ContextMenuSeparator />-->
      <CustomContextMenuItem :disabled="!hasElements" @click="handleRaise">
        <template #icon><LucideArrowBigUp /></template>
        <template #default>{{ $t('workspace.context-menu.raise.label') }}</template>
      </CustomContextMenuItem>
      <CustomContextMenuItem :disabled="!hasElements" @click="handleLower">
        <template #icon><LucideArrowBigDown /></template>
        <template #default>{{ $t('workspace.context-menu.lower.label') }}</template>
      </CustomContextMenuItem>
      <ContextMenuSeparator />
      <CustomContextMenuItem :disabled="!hasElements" @click="handleDeletion" class="text-destructive">
        ...
        <template #default>{{ $t('workspace.context-menu.delete.label') }}</template>
        <template #shortcut>{{ $t('workspace.context-menu.delete.shortcut') }}</template>
      </CustomContextMenuItem>
    </ContextMenuContent>
  </ContextMenu>
</template>
